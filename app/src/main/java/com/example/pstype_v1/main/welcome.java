...
public class welcome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int color1 = ContextCompat.getColor(this, R.color.colorOrange);
        final int color2 = ContextCompat.getColor(this, R.color.colorLightBlue);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        int[] bgs = new int[]{R.drawable.logo, R.drawable.logo2};
